...
const ActionProvider = ({ createChatBotMessage, setState, children }) => {
  ...
  const sorry = () => {
    const botMessage = createChatBotMessage('Sorry, I do not know the answer to your question or what you have said, I can only answer questions regarding the website and its services.');
    setState((prev) => ({
      ...prev,
      messages: [...prev.messages, botMessage],
    }));
